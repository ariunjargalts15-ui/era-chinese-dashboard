...
(function (global) {
  ...
  var P = {
    ...
    facebook: '<path d="M14 8.5V7c0-.9.6-1.2 1-1.2h2V3h-2.6C11.5 3 11 5 11 6.4v2.1H9V11h2v10h3V11h2.3l.4-2.5H14Z"/>',
    ...
    phone: '<path d="M6.5 3h3l1.5 4-2 1.4a12 12 0 0 0 5.6 5.6L16 12l4 1.5v3a2 2 0 0 1-2.2 2A16.5 16.5 0 0 1 3.5 5.2 2 2 0 0 1 5.5 3Z"/>',
    mail: '<rect x="3" y="5" width="18" height="14" rx="2"/><path d="m3.5 7 8.5 6 8.5-6"/>',
    lock: '<rect x="4" y="10.5" width="16" height="10.5" rx="2.5"/><path d="M8 10.5V7.4a4 4 0 0 1 8 0v3.1"/>',
    user: '<circle cx="12" cy="8" r="4"/><path d="M4.5 21v-1.5a5.5 5.5 0 0 1 5.5-5.5h4a5.5 5.5 0 0 1 5.5 5.5V21"/>',
