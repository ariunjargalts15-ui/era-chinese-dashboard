...
(function (global) {
  ...
  var MN = {
    ...
    /* the learning path */
    'Course content': 'Сургалтын агуулга',
    'Learning path': 'Сургалтын зам',
    'No units yet': 'Бүлэг алга байна',
    'The teacher has not added any lessons yet.': 'Багш хараахан хичээл нэмээгүй байна.',
    'Total XP': 'Нийт оноо',
    'Day streak': 'Дараалсан өдөр',
    'Units passed': 'Давсан бүлэг',
    'Locked': 'Түгжээтэй',
    'Start here': 'Эндээс эхэлнэ',
    'Leave': 'Гарах',
    'Hearts': 'Амь',
    'Match the pairs': 'Хосыг нь тааруулна уу',
    'What does this mean?': 'Энэ ямар утгатай вэ?',
    'Choose the word that means «{word}»': '«{word}» гэсэн утгатай үгийг сонгоно уу',
    'How is this read?': 'Үүнийг хэрхэн уншдаг вэ?',
    'Listen and choose': 'Сонсоод зөв хариултыг сонгоно уу',
    'Listen': 'Сонсох',
    'Tap a character, then its meaning': 'Эхлээд ханзаа, дараа нь утгыг нь дарна уу',
    'Check': 'Шалгах',
    'Correct!': 'Зөв байна!',
    'Not quite': 'Буруу байна',
    'Correct answer: {a}': 'Зөв хариулт: {a}',
    'Continue': 'Үргэлжлүүлэх',
    'Out of hearts': 'Амь дууслаа',
    'Try the unit again — mistakes are how the words stick.': 'Бүлгээ дахин оролдоорой — алдаанаасаа суралцах тусам үг илүү сайн цээжлэгддэг.',
    'Back to the path': 'Зам руу буцах',
    'Try again': 'Дахин оролдох',
    'Perfect round!': 'Алдаагүй давлаа!',
    'Unit complete!': 'Бүлгийг амжилттай давлаа!',
    'XP earned': 'Авсан оноо',
    'Accuracy': 'Зөв хариултын хувь',
    'Maximum level reached': 'Хамгийн дээд шатанд хүрлээ',
    'Unit reached level {n}': 'Бүлэг {n}-р шатанд хүрлээ',
    'Practise again': 'Дахин давтах',
    'Next up: {title}': 'Дараагийн бүлэг: {title}',
    'Every unit is at the top level': 'Бүх бүлэг дээд шатандаа хүрсэн',
    '{xp} XP · {n}-day streak': '{xp} оноо · дараалсан {n} өдөр',
    'Continue learning': 'Суралцахаа үргэлжлүүлэх',
    'Students work through these units in order. Exercises are built from each unit’s words.': 'Сурагчид эдгээр бүлгийг дарааллаар нь судална. Даалгаврууд бүлэг бүрийн үгсээс автоматаар үүснэ.',
    'Load the starter course': 'Бэлэн хөтөлбөр оруулах',
    'New unit': 'Шинэ бүлэг',
    'Units': 'Бүлгүүд',
    '{n} of {m} students passed': '{m} сурагчаас {n} нь давсан',
    'Move up': 'Дээш зөөх',
    'Move down': 'Доош зөөх',
    'Add the first unit to start the learning path.': 'Сургалтын замыг эхлүүлэхийн тулд эхний бүлгээ нэмнэ үү.',
    'Unit title': 'Бүлгийн нэр',
    'e.g. Greetings': 'жишээ нь: Мэндчилгээ',
    'Chinese title': 'Хятад нэр',
    'Words — one per line: character | pinyin | meaning': 'Үгс — мөр бүрт нэг үг: ханз | пиньинь | утга',
    'At least 4 words. Exercises are generated from them automatically.': 'Дор хаяж 4 үг оруулна уу. Даалгаврууд эдгээр үгсээс автоматаар үүснэ.',
    'The unit needs a title': 'Бүлгийн нэрийг оруулна уу',
    'Line {n} needs three parts': '{n}-р мөрөнд ханз, пиньинь, утга гурвуулаа байх ёстой',
    'Line {n} repeats a word': '{n}-р мөрөнд давхардсан үг байна',
    'A unit needs at least 4 words': 'Бүлэгт дор хаяж 4 үг байх ёстой',
    'Complete the previous unit first': 'Эхлээд өмнөх бүлгийг давна уу',
    'This unit is not ready yet': 'Энэ бүлэг хараахан бэлэн болоогүй байна',
    'Leave the lesson?': 'Хичээлээс гарах уу?',
    'Your progress in this round will not be saved.': 'Энэ удаагийн явц хадгалагдахгүй.',
    'Create unit': 'Бүлэг үүсгэх',
    'Unit saved': 'Бүлэг хадгалагдлаа',
    'Edit unit': 'Бүлэг засах',
    'Delete unit': 'Бүлэг устгах',
    'Delete «{title}»? Students lose their progress in it.': '«{title}» бүлгийг устгах уу? Сурагчдын энэ бүлэг дэх ахиц хамт устана.',
    'Unit deleted': 'Бүлэг устгагдлаа',
    'Starter course added': 'Бэлэн хөтөлбөр нэмэгдлээ',
    /* news & noticeboard */
  ...
  var ZH = {
    ...
    'Learning path': '学习路径',
    'No units yet': '还没有单元',
    'The teacher has not added any lessons yet.': '老师还没有添加课程。',
    'Total XP': '总经验值',
    'Day streak': '连续天数',
    'Units passed': '已通过单元',
    'Locked': '未解锁',
    ...
    'Leave': '离开',
    'Hearts': '生命值',
    'Match the pairs': '把对应的词配对',
    'What does this mean?': '这是什么意思？',
    'Choose the word that means «{word}»': '选出意思是「{word}」的词',
    'How is this read?': '这个怎么读？',
    'Listen and choose': '听一听，选出正确答案',
    'Listen': '听',
    'Tap a character, then its meaning': '先点汉字，再点它的意思',
    'Check': '检查',
    'Correct!': '正确！',
    'Not quite': '不对',
    'Correct answer: {a}': '正确答案：{a}',
    'Continue': '继续',
    'Out of hearts': '生命值用完了',
    'Try the unit again — mistakes are how the words stick.': '再试一次吧——出过错的词记得更牢。',
    'Back to the path': '返回学习路径',
    'Try again': '再试一次',
    'Perfect round!': '全部答对！',
    'Unit complete!': '单元完成！',
    'XP earned': '获得经验值',
    ...
    'Unit reached level {n}': '单元升到第 {n} 级',
    'Practise again': '再练一次',
    'Next up: {title}': '下一个：{title}',
    'Every unit is at the top level': '所有单元都已达到最高等级',
    '{xp} XP · {n}-day streak': '{xp} 经验值 · 连续 {n} 天',
    'Continue learning': '继续学习',
    'Students work through these units in order. Exercises are built from each unit’s words.': '学生按顺序学习这些单元，练习题根据每个单元的词语自动生成。',
    'Load the starter course': '导入入门课程',
    'New unit': '新单元',
    'Units': '单元',
    '{n} of {m} students passed': '{m} 名学生中 {n} 名已通过',
    'Move up': '上移',
    'Move down': '下移',
    'Edit': '编辑',
    'Add the first unit to start the learning path.': '添加第一个单元，开启学习路径。',
    'Unit title': '单元名称',
    'e.g. Greetings': '例如：问候',
    'Chinese title': '中文名称',
    'Words — one per line: character | pinyin | meaning': '词语——每行一个：汉字 | 拼音 | 释义',
    'At least 4 words. Exercises are generated from them automatically.': '至少 4 个词，练习题会根据它们自动生成。',
    'The unit needs a title': '请填写单元名称',
    'Line {n} needs three parts': '第 {n} 行需要汉字、拼音、释义三部分',
    'Line {n} repeats a word': '第 {n} 行的词重复了',
    'A unit needs at least 4 words': '一个单元至少需要 4 个词',
    'Complete the previous unit first': '请先完成上一个单元',
    'This unit is not ready yet': '这个单元还没准备好',
    'Leave the lesson?': '要离开课程吗？',
    'Your progress in this round will not be saved.': '本轮进度不会被保存。',
    'Create unit': '创建单元',
    'Unit saved': '单元已保存',
    'Edit unit': '编辑单元',
    'Delete unit': '删除单元',
    'Delete «{title}»? Students lose their progress in it.': '删除「{title}」？学生在该单元的进度也会一并删除。',
    'Unit deleted': '单元已删除',
    'Starter course added': '入门课程已添加',
    /* news & noticeboard */
