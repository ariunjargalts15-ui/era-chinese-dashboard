...
(function (global) {
  ...
  var MN = {
    ...
    /* signing in, invitations */
    'Invite a student': 'Сурагч урих',
    'Invite a teacher': 'Багш урих',
    'Class they are joining': 'Элсэх анги',
    'They register on the school site with this email and choose their own password. Their name and role are filled in for them.': 'Тэд сургуулийн хуудсаар энэ и-мэйлээр бүртгүүлж, нууц үгээ өөрсдөө сонгоно. Нэр, эрх нь автоматаар бөглөгдөнө.',
    'Save invitation': 'Урилга хадгалах',
    'Invitation saved for {email}': '{email} хаягт урилга хадгалагдлаа',
    'Cancel invitation': 'Урилга цуцлах',
    '{email} will no longer be recognised when they sign up.': '{email} бүртгүүлэхэд урилга нь хүчингүй болно.',
    'Invited, not signed up yet': 'Урьсан, хараахан бүртгүүлээгүй',
    'That email has already been invited': 'Энэ и-мэйлд аль хэдийн урилга илгээсэн байна',
    'Someone new? Invite them under Students → New student; they appear here once they sign up.': 'Шинэ хүн үү? Сурагчид → Шинэ сурагч хэсгээс урина уу. Бүртгүүлсний дараа энд гарч ирнэ.',
    'Confirm your email first — open the link we sent you': 'Эхлээд и-мэйлээ баталгаажуулна уу — бидний илгээсэн холбоосыг нээнэ үү',
    'Too many sign-ups in a short time. Try again in a few minutes.': 'Богино хугацаанд хэт олон бүртгэл хийгдлээ. Хэдэн минутын дараа дахин оролдоно уу.',
    'Too many attempts. Wait a minute and try again.': 'Хэт олон оролдлого хийлээ. Нэг минут хүлээгээд дахин оролдоно уу.',
    'That password is too weak': 'Нууц үг хэт сул байна',
    'Registration is closed': 'Бүртгэл хаалттай байна',
    'Could not reach the school. Check your internet connection.': 'Сургуулийн системтэй холбогдож чадсангүй. Интернэт холболтоо шалгана уу.',
    'Your account has no profile in the school database yet. Ask the school to finish setting it up.': 'Таны бүртгэл сургуулийн өгөгдлийн санд хараахан үүсээгүй байна. Сургуульд хандаж тохиргоог дуусгуулна уу.',
    'The school could not be opened. Try again in a moment.': 'Системийг нээж чадсангүй. Түр хүлээгээд дахин оролдоно уу.',
    'That confirmation link has expired or was already used. Sign in, or register again to get a new one.': 'Баталгаажуулах холбоосын хугацаа дууссан эсвэл аль хэдийн ашиглагдсан байна. Нэвтэрнэ үү, эсвэл шинэ холбоос авахаар дахин бүртгүүлнэ үү.',
    'We sent a confirmation link to {email}. Open it, then sign in here.': '{email} хаяг руу баталгаажуулах холбоос илгээлээ. Холбоосыг нээгээд энд нэвтэрнэ үү.',
    'A change could not be saved. Check your connection — it will be retried.': 'Өөрчлөлт хадгалагдсангүй. Холболтоо шалгана уу — дахин оролдох болно.',
    'The new teacher first registers on the school site like anyone else. Then pick them here.': 'Шинэ багш эхлээд сургуулийн хуудсаар бусадтай адил бүртгүүлнэ. Дараа нь түүнийг эндээс сонгоно уу.',
    'Registered person': 'Бүртгүүлсэн хүн',
    'A teacher sees every class, register, grade and invoice in the school.': 'Багш сургуулийн бүх анги, ирц, дүн, төлбөрийг харах эрхтэй.',
    'Nobody has registered yet.': 'Хараахан хэн ч бүртгүүлээгүй байна.',
    ...
    'Messages': 'Мессеж',
    'You: ': 'Та: ',
    'No messages yet': 'Мессеж алга',
    'Nobody to message yet': 'Мессеж бичих хүн алга байна',
    'Students of your classes appear here.': 'Таны ангийн сурагчид энд харагдана.',
    'Your teachers appear here once you are in a class.': 'Ангид орсны дараа багш нар тань энд харагдана.',
    'Choose a conversation': 'Харилцан яриа сонгоно уу',
    'Ask your teacher anything about your lessons.': 'Хичээлийнхээ талаар багшаасаа юу ч асууж болно.',
    'Pick a student on the left.': 'Зүүн талаас сурагч сонгоно уу.',
    'Seen': 'Уншсан',
    'Sent': 'Илгээсэн',
    'No messages yet. Say hello!': 'Одоогоор мессеж алга. Мэндээ хүргээрэй!',
    'Write a message…': 'Мессеж бичих…',
    'Send': 'Илгээх',
    'Write a message first': 'Эхлээд мессежээ бичнэ үү',
    'That message is too long': 'Мессеж хэт урт байна',
    'Messages go between a student and a teacher': 'Мессеж зөвхөн сурагч, багш хоёрын хооронд илгээгдэнэ',
    'You cannot message this person': 'Та энэ хүнд мессеж бичих боломжгүй',
    'New message': 'Шинэ мессеж ирлээ',
    /* online lessons */
    'Online lessons': 'Онлайн хичээл',
    'Live now · {n} min': 'Шууд явагдаж байна · {n} мин',
    'in {d} days': '{d} хоногийн дараа',
    'in {h} h {m} min': '{h} цаг {m} минутын дараа',
    'in {n} min': '{n} минутын дараа',
    'Should have started {n} min ago': '{n} минутын өмнө эхлэх ёстой байсан',
    'Finished': 'Дууссан',
    '{n} min': '{n} мин',
    '{n} of {m} in the room': '{m} хүнээс {n} нь өрөөнд байна',
    '{n} of {m} attended': '{m} хүнээс {n} нь ирсэн',
    '{n} invited': '{n} сурагч урьсан',
    'Go to the room': 'Өрөө рүү орох',
    'Start now': 'Одоо эхлүүлэх',
    'Remind again': 'Дахин сануулах',
    'Remind by message': 'Мессежээр сануулах',
    'Open the register': 'Ирцийг нээх',
    'Only the students you invite can enter an online lesson.': 'Онлайн хичээлд зөвхөн таны урьсан сурагчид орно.',
    'New online lesson': 'Шинэ онлайн хичээл',
    'Live now': 'Одоо явагдаж буй',
    'Coming up': 'Удахгүй болох',
    'Nothing scheduled. Create an online lesson and invite students.': 'Товлосон хичээл алга. Онлайн хичээл үүсгээд сурагчдаа урина уу.',
    'Past lessons': 'Өнгөрсөн хичээлүүд',
    'Waiting for the teacher to open the room': 'Багш өрөөг нээхийг хүлээж байна',
    'Add to calendar': 'Календарьт нэмэх',
    'Test camera & mic': 'Камер, микрофон шалгах',
    'Attended': 'Ирсэн',
    'Missed': 'Ирээгүй',
    'Not recorded': 'Бүртгэгдээгүй',
    'No online lessons yet': 'Онлайн хичээл алга байна',
    'When your teacher invites you to an online lesson it appears here.': 'Багш таныг онлайн хичээлд урихад энд харагдана.',
    'No upcoming online lessons.': 'Удахгүй болох онлайн хичээл алга.',
    'This class has no students yet.': 'Энэ ангид одоогоор сурагч алга.',
    'Select all': 'Бүгдийг сонгох',
    'e.g. Speaking practice': 'жишээ нь: Ярианы дадлага',
    'Length': 'Үргэлжлэх хугацаа',
    'What you will cover': 'Хичээлийн агуулга',
    'Students see this before they join': 'Сурагчид нэгдэхээсээ өмнө үүнийг харна',
    'Video': 'Видео',
    'Built-in video room': 'Системийн видео өрөө',
    'My own link (Zoom, Meet…)': 'Өөрийн холбоос (Zoom, Meet…)',
    'Meeting link (only for your own link)': 'Хурлын холбоос (зөвхөн өөрийн холбоос сонгосон үед)',
    'Invited students': 'Урих сурагчид',
    'Edit online lesson': 'Онлайн хичээл засах',
    'Schedule': 'Товлох',
    'Online lesson saved — {n} students invited': 'Онлайн хичээл хадгалагдлаа — {n} сурагч урилаа',
    'Hello! The online lesson «{title}» starts on {date} at {time}. Join it from the Online lessons page.': 'Сайн байна уу! «{title}» онлайн хичээл {date}-ны {time} цагт эхэлнэ. «Онлайн хичээл» хэсгээс нэгдэнэ үү.',
    'This message goes to {n} invited students:': 'Энэ мессеж урьсан {n} сурагчид илгээгдэнэ:',
    'Reminder sent to {n} students': '{n} сурагчид сануулга илгээлээ',
    'Delete online lesson': 'Онлайн хичээл устгах',
    'Delete «{title}»? Its register goes with it.': '«{title}» хичээлийг устгах уу? Ирцийн бүртгэл нь хамт устана.',
    'Deleted': 'Устгагдлаа',
    'Allow the browser to use your camera and microphone.': 'Browser-т камер, микрофоноо ашиглах зөвшөөрөл өгнө үү.',
    'Done': 'Болсон',
    'This browser cannot use a camera. Try Chrome or Safari.': 'Энэ browser камер ашиглах боломжгүй. Chrome эсвэл Safari ашиглана уу.',
    'If you can see yourself and the bar moves when you speak, you are ready.': 'Өөрийгөө харж, ярихад зурвас хөдөлж байвал та бэлэн байна.',
    'Access was blocked. Allow the camera and microphone in the browser settings.': 'Хандалт хаагдсан байна. Browser-ийн тохиргооноос камер, микрофоныг зөвшөөрнө үү.',
    'No camera or microphone was found.': 'Камер эсвэл микрофон олдсонгүй.',
    'The lesson needs a title': 'Хичээлийн нэрийг оруулна уу',
    'Pick a date': 'Огноо сонгоно уу',
    'Pick a time': 'Цаг сонгоно уу',
    'Invite at least one student': 'Дор хаяж нэг сурагч урина уу',
    'The meeting link must start with https://': 'Хурлын холбоос https:// -ээр эхлэх ёстой',
    'You were not invited to this online lesson': 'Таныг энэ онлайн хичээлд уриагүй байна',
    'Register saved: {p} present, {a} absent': 'Ирц бүртгэгдлээ: {p} ирсэн, {a} ирээгүй',
    /* news & noticeboard */
  ...
  var ZH = {
    ...
    /* signing in, invitations */
    'Invite a student': '邀请学生',
    'Invite a teacher': '邀请教师',
    'Class they are joining': '要加入的班级',
    'They register on the school site with this email and choose their own password. Their name and role are filled in for them.': '对方用这个邮箱在学校网站注册，自己设置密码，姓名和身份会自动填好。',
    'Save invitation': '保存邀请',
    'Invitation saved for {email}': '已为 {email} 保存邀请',
    'Cancel invitation': '取消邀请',
    '{email} will no longer be recognised when they sign up.': '{email} 注册时将不再被识别为受邀者。',
    'Invited, not signed up yet': '已邀请，尚未注册',
    'That email has already been invited': '该邮箱已被邀请',
    'Someone new? Invite them under Students → New student; they appear here once they sign up.': '新同学？请在「学生 → 新学生」中邀请，对方注册后会出现在这里。',
    'Confirm your email first — open the link we sent you': '请先确认邮箱——打开我们发送的链接',
    'Too many sign-ups in a short time. Try again in a few minutes.': '短时间内注册次数过多，请几分钟后再试。',
    'Too many attempts. Wait a minute and try again.': '尝试次数过多，请稍等一分钟再试。',
    'That password is too weak': '密码太弱',
    'Registration is closed': '注册已关闭',
    'Could not reach the school. Check your internet connection.': '无法连接学校系统，请检查网络连接。',
    'Your account has no profile in the school database yet. Ask the school to finish setting it up.': '你的账号在学校数据库中还没有资料，请联系学校完成设置。',
    'The school could not be opened. Try again in a moment.': '无法打开学校系统，请稍后再试。',
    'That confirmation link has expired or was already used. Sign in, or register again to get a new one.': '确认链接已过期或已被使用。请直接登录，或重新注册以获取新链接。',
    'We sent a confirmation link to {email}. Open it, then sign in here.': '确认链接已发送到 {email}，打开链接后在这里登录。',
    'A change could not be saved. Check your connection — it will be retried.': '有更改未能保存，请检查网络——系统会自动重试。',
    'The new teacher first registers on the school site like anyone else. Then pick them here.': '新老师先像其他人一样在学校网站注册，然后在这里选择他。',
    'Registered person': '已注册的人',
    'A teacher sees every class, register, grade and invoice in the school.': '老师可以查看学校所有班级、考勤、成绩和账单。',
    'Nobody has registered yet.': '还没有人注册。',
    'Make teacher': '设为老师',
    ...
    'Nobody to message yet': '还没有可以联系的人',
    'Students of your classes appear here.': '你班上的学生会显示在这里。',
    'Your teachers appear here once you are in a class.': '加入班级后，你的老师会显示在这里。',
    'Choose a conversation': '选择一个对话',
    'Ask your teacher anything about your lessons.': '关于课程的任何问题都可以问老师。',
    'Pick a student on the left.': '在左侧选择一名学生。',
    'Seen': '已读',
    'Sent': '已发送',
    'No messages yet. Say hello!': '还没有消息，打个招呼吧！',
    'Write a message…': '输入消息…',
    'Send': '发送',
    'Write a message first': '请先输入消息',
    'That message is too long': '消息太长了',
    'Messages go between a student and a teacher': '消息只能在学生和老师之间发送',
    'You cannot message this person': '你不能给此人发消息',
    'New message': '有新消息',
    /* online lessons */
    'Online lessons': '在线课程',
    'Live now · {n} min': '正在直播 · {n} 分钟',
    'in {d} days': '{d} 天后',
    'in {h} h {m} min': '{h} 小时 {m} 分钟后',
    'in {n} min': '{n} 分钟后',
    'Should have started {n} min ago': '本应在 {n} 分钟前开始',
    'Finished': '已结束',
    '{n} min': '{n} 分钟',
    '{n} of {m} in the room': '{m} 人中 {n} 人在房间里',
    '{n} of {m} attended': '{m} 人中 {n} 人出席',
    '{n} invited': '已邀请 {n} 人',
    'Go to the room': '进入房间',
    'Start now': '现在开始',
    'Remind again': '再次提醒',
    'Remind by message': '通过消息提醒',
    'Open the register': '打开考勤',
    'Only the students you invite can enter an online lesson.': '只有你邀请的学生才能进入在线课程。',
    'New online lesson': '新建在线课程',
    'Live now': '正在进行',
    'Coming up': '即将开始',
    'Nothing scheduled. Create an online lesson and invite students.': '暂无安排。创建在线课程并邀请学生吧。',
    'Past lessons': '已结束的课程',
    'Waiting for the teacher to open the room': '等待老师开放房间',
    'Add to calendar': '添加到日历',
    'Test camera & mic': '测试摄像头和麦克风',
    'Attended': '已出席',
    'Late': '迟到',
    'Missed': '缺席',
    'Not recorded': '未记录',
    'No online lessons yet': '还没有在线课程',
    'When your teacher invites you to an online lesson it appears here.': '老师邀请你参加在线课程后，会显示在这里。',
    'No upcoming online lessons.': '暂无即将开始的在线课程。',
    'This class has no students yet.': '这个班级还没有学生。',
    '{n} students': '{n} 名学生',
    'Select all': '全选',
    'e.g. Speaking practice': '例如：口语练习',
    'Length': '时长',
    'What you will cover': '课程内容',
    'Students see this before they join': '学生加入前可以看到',
    'Video': '视频',
    'Built-in video room': '内置视频房间',
    'My own link (Zoom, Meet…)': '我自己的链接（Zoom、Meet…）',
    'Meeting link (only for your own link)': '会议链接（仅在使用自己的链接时填写）',
    'Invited students': '邀请的学生',
    'Edit online lesson': '编辑在线课程',
    'Schedule': '安排',
    'Online lesson saved — {n} students invited': '在线课程已保存——已邀请 {n} 名学生',
    'Hello! The online lesson «{title}» starts on {date} at {time}. Join it from the Online lessons page.': '你好！在线课程「{title}」将于 {date} {time} 开始，请在「在线课程」页面加入。',
    'This message goes to {n} invited students:': '这条消息将发送给 {n} 名受邀学生：',
    'Send': '发送',
    'Reminder sent to {n} students': '已向 {n} 名学生发送提醒',
    'Delete online lesson': '删除在线课程',
    'Delete «{title}»? Its register goes with it.': '删除「{title}」？它的考勤记录也会一并删除。',
    'Deleted': '已删除',
    'Allow the browser to use your camera and microphone.': '请允许浏览器使用摄像头和麦克风。',
    'Done': '完成',
    'This browser cannot use a camera. Try Chrome or Safari.': '此浏览器无法使用摄像头，请使用 Chrome 或 Safari。',
    'If you can see yourself and the bar moves when you speak, you are ready.': '如果能看到自己，说话时音量条在动，就说明准备好了。',
    'Access was blocked. Allow the camera and microphone in the browser settings.': '访问被阻止，请在浏览器设置中允许摄像头和麦克风。',
    'No camera or microphone was found.': '未找到摄像头或麦克风。',
    'Pick a class': '请选择班级',
    'The lesson needs a title': '请填写课程名称',
    'Pick a date': '请选择日期',
    'Pick a time': '请选择时间',
    'Invite at least one student': '请至少邀请一名学生',
    'The meeting link must start with https://': '会议链接必须以 https:// 开头',
    'That lesson does not exist': '该课程不存在',
    'You were not invited to this online lesson': '你没有被邀请参加这节在线课程',
    'Register saved: {p} present, {a} absent': '考勤已保存：出席 {p} 人，缺席 {a} 人',
    'Create a class first': '请先创建班级',
    /* news & noticeboard */
